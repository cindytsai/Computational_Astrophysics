...
// find the minimum dt in the root
   ...
   MPI_Reduce( &dt_MyRank, &dt_AllRank, Count, MPI_FLOAT, MPI_MIN, RootRank, MPI_COMM_WORLD );


// broadcast the minimum dt from the root rank to others
   MPI_Bcast( &dt_AllRank, Count, MPI_FLOAT, RootRank, MPI_COMM_WORLD );
